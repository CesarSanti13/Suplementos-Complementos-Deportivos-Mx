...
#Tomando el DF principal de los ENVIOS, agrupamos por el mes y por el producto el unico que existe es de ENVIO, sumando los GASTOS de estos
#observando el total de GASTOS de ENVIOS que ha existido por cada mes
dfEnviosMes = dfEnvios.groupby(['Mes','Producto'])['Total'].sum().reset_index(name='Gasto Envio')
dfEnviosMes